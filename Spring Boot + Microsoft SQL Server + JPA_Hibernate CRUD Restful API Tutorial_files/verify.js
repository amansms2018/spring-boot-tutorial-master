    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'6378bd14e64747c1be51a3f89636d0f3',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_652333400378');
                if (frame) {
...
;np764531("6378bd14e64747c1be51a3f89636d0f3",false);


try{__tagObject_callback_652333400378({ImpressionID:"6378bd14e64747c1be51a3f89636d0f3", ServerPublicDns:"tps621.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "6378bd14e64747c1be51a3f89636d0f3");}catch(e){}
try{__verify_callback_652333400378({
ResultID:2,
Passback:"",
AdWidth:160,
AdHeight:600});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "6378bd14e64747c1be51a3f89636d0f3");}catch(e){}
