//Generated:2020-07-31 19:35:03// 6-241
(function(){
    var o = {
    $: function(el) {
        var x = el || o.divID, p = {
    ...
    (function() {
    var p = "4163942", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    }, u = navigator.userAgent, p = navigator.platform, ios = p.slice(0, 2) === 'iP' && getVersion('OS'), ie = ~u.search(/MSIE|Trident|Edge/), edge = ~u.search(/ Edg\//i) && getVersion('Edg'), android = !ie && getVersion('Android'), aosp = !!(~u.indexOf('; U;') || ~u.indexOf('Verson')) && android, chriOS = !ie && getVersion('ChriOS'), is = {
    ...
    var data = {
    params:window.ftParams_4163942||'',
    guid:window.ftGUID_4163942||'',
    confID:window.ftConfID_4163942||'0',
    ftReturn: window.ftReturn_4163942||'',
    keyword:window.ftKeyword_4163942||'',
    ftId:window.ftId_4163942||'',
    ftImpId:window.ftImp4163942 && window.ftImp4163942.impID || '',
    campaignID: '115749',
    cID:'122595',
    pID:'4163942',
    creativeID:'3139315',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115749&sid=18300&plc=4163942&num=&adid=&advid=&adsrv=29&btreg=4163942&btadsrv=flashtalking&crt=3139315&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/115749;4163942;3139315;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://acrobat.adobe.com/us/en/free-trial-download.html?sdid=7RZ367W3&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?185420099-4163942;3139315;',
    centreAd: false,
    width:160,
    height:600,
    adType:'custom_rule'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/416/4163942/3139315/image/3139315.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115749;4163942;202;pixel;Verizon;VerizonFY20AcrobatLALAcrobatTrialistUSDSKBAN160x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/115749;4163942;3139315;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://acrobat.adobe.com/us/en/free-trial-download.html?sdid=7RZ367W3&mv=display',
    divID:'ftdiv4163942',
    altimgID:'ftalt4163942',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4163942 && parseInt(window.ftImp4163942.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4163942') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4163942'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe4163942';
    o.file = 'http://cdn.flashtalking.com/122595/3139315/index.html';
    o.altImg = 'http://servedby.flashtalking.com/imp/8/115749;4163942;204;gif;Verizon;VerizonFY20AcrobatLALAcrobatTrialistUSDSKBAN160x600/?';
