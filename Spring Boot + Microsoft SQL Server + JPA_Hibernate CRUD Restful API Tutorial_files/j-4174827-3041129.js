...
(function(){
  var o = {
    ...
    (function() {
        var p = "4174827", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_4174827||'',
        GUID:window.ftGUID_4174827||'99999999999',
        confID:window.ftConfID_4174827||'0',
        ftReturn: window.ftReturn_4174827||'',
        keyword:window.ftKeyword_4174827||'',
        ftId:window.ftId_4174827||'',
        imp:window.ftImp4174827,
        ftImpId:window.ftImp4174827 && window.ftImp4174827.impID || '',
        campaignID:'115738',
        cID:'121046',
        pID:'4174827',
        creativeID:'3041129',
        exttrack:[],
        extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115738&sid=18300&plc=4174827&num=&adid=&advid=&adsrv=29&btreg=4174827&btadsrv=flashtalking&crt=3041129&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
        clickTags: ["http://servedby.flashtalking.com/click/8/115738;4174827;3041129;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/creativecloud/plans.html?plan=edu&locale=en&sdid=TKZTLFVF&mv=display"],
        placementDescription:'VerizonFY20EDULALEDUPurchaseUSDSKBAN160x600',
        width:160,
        height:600,
        ...
        divID:'ftdiv4174827',
        phID:'ftpos4174827',
        frameID:'ftframe4174827',
        expID:'ftexpframe4174827',
        altImgID:'ftalt4174827',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/115738;4174827;3041129;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/creativecloud/plans.html?plan=edu&locale=en&sdid=TKZTLFVF&mv=display',
        altImg:'http://servedby.flashtalking.com/imp/8/115738;4174827;204;gif;Verizon;VerizonFY20EDULALEDUPurchaseUSDSKBAN160x600/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/115738;4174827;271;pixel;Verizon;VerizonFY20EDULALEDUPurchaseUSDSKBAN160x600/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/417/4174827/3041129/js/j-4174827-3041129.js',
        file:'http://cdn.flashtalking.com/121046/3041129/index.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?178801695-4174827;3041129;',
        adVis:false ? 1 : 0,
        centreAd:true,
        mvt:true,
        segment:window.ftSegment_4174827||'',
        segmentList:window.ftSegmentList_4174827||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp4174827 && window.ftImp4174827.jsAppend),
        mayExpand: +'0' > 600 || +'0' > 160,
        noBreakout:false,
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4174827')&&/^https:/.test(document.getElementById('ftscript_m4174827').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m4174827'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_4174827'],
            ['ftcfid', 'ftConfID_4174827'],
            ['fttime', 'ftTimestamp_4174827'],
            ['ftsection', 'ftSection_4174827'],
            ['ftcustom', 'ftCustom_4174827'],
            ['ft_id', 'ftId_4174827'],
            ['ftimpid','ftImp4174827', 'impID']
        ]
    };
